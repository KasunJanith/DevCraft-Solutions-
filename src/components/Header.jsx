...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 glass-effect border-b border-border-light/50 dark:border-border-dark/50 backdrop-blur-md bg-white/80 dark:bg-background-dark/80">
